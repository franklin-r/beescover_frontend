...
export const coverageProofAbi			= [
	...
	},
	{
		...
		"inputs": [
			...
			{
				"indexed": false,
				"internalType": "enum Types.CoverageStatus",
				"name": "_oldStatus",
				"type": "uint8"
			},
			{
	...
	{
		"inputs": [],
		"name": "COVERAGE_PROOF_ADMIN_ROLE",
		"outputs": [
			{
				"internalType": "bytes32",
				"name": "",
